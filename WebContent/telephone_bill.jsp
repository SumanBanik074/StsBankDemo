...
<html>
<head>
<title>STS Bank&reg; Telephone bill </title>
...
<body>
  				...
  				<ul class="nav navbar-nav">
     					...
     					<li class="dropdown">
   							...
   							<ul class="dropdown-menu">					     							
   								<li class="active"><a href="telephone_bill.jsp">Telephone Bills</a></li>
	...
	<br>
		<div class="row">
			...
			<form action="teleBill" name="ts" method="post" onsubmit="return validcheck()">
   				<table class="table table-bordered">
   					<tr><th colspan="2" style="text-align: center;" class="p1"><h1 style="color: white;">Pay Telephone Bills</h1></th></tr>
   					...
   					<tr><td style="text-align: center;"><h4>Telephone bill ID</h4></td><td style="text-align: center;"><input type="text" name="tbill" class="form-control" placeholder="Enter Telephone bill ID "></td></tr>
